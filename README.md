...
Live MCP URL: **https://kitesurf-mcp.personal-7f1.workers.dev/mcp**

Owner sign-in and passkey enrollment:
**https://kitesurf-mcp.personal-7f1.workers.dev/**
...
1. In ChatGPT's **New Plugin** dialog, enter **Kitesurf** and the live MCP URL
   above, or your own deployment's `https://YOUR-WORKER-HOST/mcp`.
