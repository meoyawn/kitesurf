...
<p id="message" role="status" aria-live="polite"></p><footer>OAuth protects every browser request. Browsers close after five minutes of inactivity; ask ChatGPT to close the browser when finished.</footer>
</main></body></html>`;
